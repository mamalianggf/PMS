...
<form id="user_form" class="layui-form" action="" style=" width: 40%;min-width:400px;">
    ...
    <%--<div class="layui-form-item layui-form-text">
        <label class="layui-form-label" id="addressLabel">地址</label>
        <div class="layui-input-block">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <select name="roleId" lay-verify="required" lay-filter="type">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <c:if test="${method =='add'}">
                <button id="form" method="add" class="layui-btn" lay-submit lay-filter="peopleform">提交</button>
            </c:if>
            <c:if test="${method =='update'}">
                <button id="form" method="update" class="layui-btn" lay-submit lay-filter="peopleform">保存</button>
            </c:if>
...
<script src="<%=basePath%>js/peopleSubmit.js"></script>
</html>
